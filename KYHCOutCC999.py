...
f = open("C:/Users/joseph.petitt/Documents/SFTP_Files/Working/KYHCOutCC999DE.txt","w") #Enter the txt file you want the parsed 837's to be written to
if __name__ == '__main__':
    # Sample usage

    
    path = 'C:/Users/joseph.petitt/Documents/SFTP_Files/CenterCare_KYHC_PROD/Inbound/Archive/kyccr*.999' #enter the directory to run the script on
