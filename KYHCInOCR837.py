...
f = open("C:/Users/joseph.petitt/Documents/SFTP_Files/Working/KYHCInOCR837DE.txt","w") #Enter the txt file you want the parsed 837's to be written to
if __name__ == '__main__':
    ...
    path = 'C:/Users/joseph.petitt/Documents/SFTP_Files/Working/OCR*.837' #enter the directory to run the script on
