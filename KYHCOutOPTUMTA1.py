...
f = open("C:/Users/joseph.petitt/Documents/SFTP_Files/KYHCOutOPTUMTA1DE.txt","w") #Enter the txt file you want the parsed 837's to be written to
if __name__ == '__main__':
    # Sample usage

   
    path = 'C:/Users/joseph.petitt/Documents/SFTP_Files/Working/OPTUM*.TA1' #enter the directory to run the script on
