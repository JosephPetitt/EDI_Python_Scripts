...
f = open("C:/Users/joseph.petitt/Documents/SFTP_Files/KYHCOutOCR277CADE.txt","w") #Enter the txt file you want the parsed 837's to be written to
if __name__ == '__main__':
    # Sample usage

    
    path = 'C:/Users/joseph.petitt/Documents/SFTP_Files/Working/OCR*.277CA' #enter the directory to run the script on
